	...
	<div class="card card-secondary card-outline">
		...
		<div class="card-header">
			<div class ="card-tools">
				...
				<button type="button" class="btn btn-warning ml-1" id="cancelBtn" onclick="history.go(-1);" >취 소</button>
			</div>
		</div>
		<!--end card-header  -->
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group-prepend">
							...
							<input type="text" class="form-control float-right" id="meetDe" name="meetDe" value=""> 
						</div>
					</div>
				</div>
				<div class="row">
...
window.addEventListener('DOMContentLoaded', proceedingsRegist);
