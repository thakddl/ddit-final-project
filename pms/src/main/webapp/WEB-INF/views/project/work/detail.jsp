		...
		<div class="card-header">
			...
			<div class="card-tools">
			  <c:if test="${empty open }">
				...
				<button type="button" id="modifyBtn" class="btn btn-warning" onclick="modifyForm_go();">수 정</button>
			  ...
			  <c:if test="${not empty open }">
				<button type="button" id="registIssueBtn" class="btn btn-primary" onclick="registIssue_go('${work.workNo}');">이슈 등록</button>
				<button type="button" id="modifyBtn" class="btn btn-warning" onclick="modifyForm_go(1);">수 정</button>
