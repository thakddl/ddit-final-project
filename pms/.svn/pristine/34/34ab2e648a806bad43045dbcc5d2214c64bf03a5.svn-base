...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>${prjNm}</h1>
				<input type="hidden" name="prjNo" value="${proceedings.prjNo }"/>
...
<section class="content">
	<div class="card card-secondary card-outline">
		...
		<div class="card-header">
			<div class ="card-tools">
					<button type="button" class="btn btn-primary" id="registBtn" onclick="regist_go();">작 성</button>
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group-prepend">
							...
							<input type="text" class="form-control float-right" id="meetDe" name="meetDe" value="${proceedings.meetDe }"> 
						</div>
					</div>
				</div>
				<div class="row">
	...
	<!-- 					<i class="fa-solid fa-user-plus"></i> -->
					...
					<div id="memberInput" class="d-flex flex-wrap mb-4"><br>&nbsp;&nbsp;&nbsp;&nbsp;
...
window.addEventListener('DOMContentLoaded', proceedingsReWrite);

function proceedingsReWrite() {
	...
	var spread = designer.getWorkbook();
		...
		var regist_go = function () {
			...
			for (item of addMembers) {
				userArray.push($(item).find("span.manPicture").data('id'));
			}
...
window.addEventListener('DOMContentLoaded', reWrite);

function reWrite() {
// 	var uArray = document.getElementsByClassName("oldMembers");
// 	for(i=0; i<uArray.length; i++) {
// 		console.log(uArray)
// 		userArray.push(uArray[i].id);
// 	}
